...
The latest version available is 6.2.0.redhat-2 and to run the installer at the command prompt use the following command:

NOTE: Starting from JBoss Data Virtualization 6.2.0 one need to install JBoss EAP 6.4.0 including patch 3 first.
