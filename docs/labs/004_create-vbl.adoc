...
Click the btn[...] to the right of Existing Model and open menu:Financials[DataSources > US_Customers]. Click btn:[OK]. You will be returned to the New Model Wizard. We are going to copy all model elements so simply click btn:[Finish] on the screen as indicated below.
